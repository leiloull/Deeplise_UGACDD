...
namespace json {
	...
	public:
		...
		char ToChar() const { bool b; return std::move(ToChar(b)); }
		char ToChar(bool &ok) const {
			ok = (Type == Class::Char);
			return ok ? Internal.Char : false;
		}
	...
	private:
		void SetType(Class type) {
			...
			case Class::Char:      Internal.Char = ' ';										break;
			}
